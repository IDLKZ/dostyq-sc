                    ...
                    <div class="overflow-hidden">
                        <table class="min-w-full text-left text-sm font-light">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-4">Наименование на каз</th>
                                <th scope="col" class="px-6 py-4">Наименование на рус</th>
                                <th scope="col" class="px-6 py-4">Наименование на анг</th>
                            ...
                            @foreach($eps as $item)
                                <tr class="border-b dark:border-neutral-500">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">{{$item->title_en}}</td>
                                    <td class="flex justify-center py-4">
                                        <a href="{{route('eps.edit', $item->id)}}" class="mr-3">
